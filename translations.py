translations = {
    'en': {
        ...
        'wallet_payment_success': 'Payment successful from wallet',
        'wallet_payment_failed': 'Payment failed from wallet',
    ...
    'fa': {
        ...
        'tooman': 'تومان',
        'off': 'تخفیف',
        'wallet_deposit': 'واریز به کیف پول',
        'wallet_withdrawal': 'برداشت از کیف پول',
        'insufficient_wallet_balance': 'موجودی کیف پول کافی نیست',
        'wallet_payment_success': 'پرداخت با موفقیت از کیف پول انجام شد',
        'wallet_payment_failed': 'پرداخت از کیف پول ناموفق بود',
