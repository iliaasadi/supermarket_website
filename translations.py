translations = {
    'en': {
        ...
        'address_description_placeholder': 'Add any additional details about this address',
    ...
    'fa': {
        ...
        'save_delivery_settings': 'ذخیره تنظیمات تحویل',
        ...
        'enter_street_address': 'آدرس خیابان را وارد کنید',
        'tag': 'برچسب',
        'tag_placeholder': 'مثال: خانه، محل کار',
        'building_unit_number': 'شماره ساختمان/واحد',
        'enter_building_unit': 'شماره ساختمان/واحد را وارد کنید',
        'description': 'توضیحات',
        'address_description_placeholder': 'اطلاعات اضافی درباره این آدرس را وارد کنید',
